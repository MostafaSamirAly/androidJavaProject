...
import com.example.mishwary.ui.notes.NoteAdapter;
...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        tripId = (String) intent.getExtras().get("tripId");
    ...
    private void setupRecycler(List<Note>notes) {
        FloatingNoteAdapter adapter = new FloatingNoteAdapter(this,notes);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        floatingNotesRecycler.setLayoutManager(layoutManager);
        floatingNotesRecycler.setHasFixedSize(true);
        floatingNotesRecycler.setAdapter(adapter);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.open_activity_button:
                ...
                Intent intent = new Intent(FloatingWidgetService.this, AddNote.class);
